...
fetch("https://iomeu-casino-client.api.relaxg.com/game/play", {
  ...
  "body": "{\"g\":\"blackjackneo\",\"sid\":\""+sid+"\",\"restoreState\":\"{}\",\"restoreVersion\":200,\"ga\":\"deal\",\"ba\":\"[0,200,0]\"}",
  "method": "POST",
  "mode": "cors",
  "credentials": "omit"
...
fetch("https://iomeu-casino-client.api.relaxg.com/capi/2.0/casino/token/gettoken", {
  ...
  "body": "{\"gameref\":\"blackjackneo\",\"ticket\":\"38C85B94F35EAED5C2AA941B3A2EE1A41BAA346A\",\"partnerid\":\"892\",\"mode\":\"dev\",\"channel\":\"web\",\"clientid\":\"\",\"clientversion\":\"2023-08-24 1.8.0\"}",
  "method": "POST"
}).then(r => r.json()).then(r => {
...
deal();
//Keep in mind that ticket in the 'gettoken' fetch is the one that chooses currencies. This is for only nzd.
});
});
};